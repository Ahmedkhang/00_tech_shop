...
const Products = () => {
    ...
    useEffect(() => {
        async function fetch_products() {
            try {
                setLoading(true)
                const products: Product_types[] = await client.fetch("*[_type == 'mobiles']")
                    ...
                    <div className={
                        ...
                        {sortedProducts.map((product) => (
                            ...
                            >
                               ...
                               <Link href={`/mobile/${product.slug.current}`}>     <div className="flex items-start justify-between mb-2">
